  ...
  return <div className="min-h-screen flex items-center justify-center p-2 md:p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-2xl relative z-[2]">
        <div className="bg-card/40 backdrop-blur-xl rounded-3xl p-4 md:p-12 border border-border shadow-2xl">
          ...
          {/* Bio */}
          <p className="text-center text-muted-foreground text-lg mb-8 leading-relaxed">MBA CIO (мастер делового администрирования в сфере информационных технологий), ИИ-энтузиаст, эксперт по проектному управлению, преподаватель, музыкант. Создаю образовательные программы и делюсь знаниями в области управления проектами и цифровой трансформации и пишу музыку, которая трогает чувства.</p>
